...
test('\nDTrace default opts integration', function(t) {
  var trace = fs.readFileSync(path.join(fixtures, 'dtrace.resolved.stack'), 'utf8').split('\n')
  var expectedJSON = fs.readFileSync(path.join(fixtures, 'dtrace.resolved.cpuprofile'), 'utf8')
